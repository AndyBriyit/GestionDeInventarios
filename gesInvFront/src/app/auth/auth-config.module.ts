    ...
    imports: [
      AuthModule.forRoot({
        config: {
          ...
          redirectUrl:'https://staging.djtzy3e0rtel.amplifyapp.com/inventory',
          //redirectUrl:'https://staging.ds0vtdas85ecg.amplifyapp.com/inventory',//URL DESPUES DE AUTENTICACION
